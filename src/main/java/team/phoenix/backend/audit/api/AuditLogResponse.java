...
// DTO usado para expor eventos de auditoria na API sem retornar diretamente o documento Mongo.
public record AuditLogResponse(
    ...
    /**
     * Converte o resultado da camada de aplicacao para o formato da resposta HTTP.
     */
