...
// Configuração de segurança - define filtro JWT, rotas públicas e autenticação stateless
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    // Configuração de CORS - permite requisições do frontend incluindo o preflight OPTIONS
    @Bean
